let EditInterview = {
    ...
    , after_render: async () => {
      ...
      document.getElementById("interviewer_id").value = interview.interviewer_id;
      document.getElementById("interviewee_id").value = interview.interviewee_id;
      document.getElementById("start_time").value = interview.start_time.substring(0,interview.start_time.length-1);
      document.getElementById("end_time").value = interview.end_time.substring(0,interview.end_time.length-1);
